def main(stl_file, prefix="PureShapes"):
    import math
    import os
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog="onshape-to-robot-pure-shape",
        description="Extract pure shapes from an STL file."
    )
    parser.add_argument("stl_file", help="Path to STL file")
    parser.add_argument("prefix", nargs="?", default="PureShapes", help="Prefix for pure shapes sketches")
    argcomplete.autocomplete(parser)
    args = parser.parse_args()
    main(args.stl_file, args.prefix)
